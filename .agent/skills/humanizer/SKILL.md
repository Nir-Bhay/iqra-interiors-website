...
## KEY AI PATTERNS TO AVOID

### Words to eliminate or reduce:
...
- underscore (verb), valuable, vibrant, nestled, groundbreaking, renowned

### Structures to avoid:
- "serves as / stands as / marks" (use "is" instead)
- "It's not just X; it's Y" (negative parallelisms)
- Rule of three patterns
- Em dash overuse
- Curly quotes " " (use straight quotes " ")
- Emoji decorations 🚀💡✅
- Boldface header lists
