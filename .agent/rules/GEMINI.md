...
## 🧠 MODEL INTELLIGENCE — MANDATORY SUBAGENT ROUTING

> 🔴 **MANDATORY:** Before spawning ANY subagent or delegating ANY task, READ `.agent/MODEL_INTELLIGENCE.md` to select the correct model for the job. Do NOT use generic models for specialized tasks.

**Quick Rules:**
- Math/Reasoning → `deepseek/deepseek-r1:free`
- Hard Coding/SWE → `nvidia/nemotron-3-super-120b-a12b`
- Agentic/Planning → `nvidia/nemotron-3-super-120b-a12b`
- Big Repo Coding → `qwen/qwen3-coder-480b-a35b:free`
- Web Research → `moonshotai/kimi-k2-thinking` (Nvidia provider)
- Vision Tasks → `nvidia/nemotron-nano-12b-2-vl:free`
- Long Writing → `stepfun/step-3.5-flash:free`
- General Chat → `meta-llama/llama-3.3-70b-instruct:free`
- Unknown/Auto → `kilo/auto`

Full profiles, benchmarks, and detailed routing logic: **`.agent/MODEL_INTELLIGENCE.md`**
